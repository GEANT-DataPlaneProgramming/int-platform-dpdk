...
const bit<16> HOP_INFO = 0x{{"{:02x}".format(l)}}{{n}}; // Field is necesary for checksum computation.

const bit<16> INSTRUCTION_MASK_COMPLET = 0x00{{"{:01x}".format(a)}}{{"{:01x}".format(k)}}; 
